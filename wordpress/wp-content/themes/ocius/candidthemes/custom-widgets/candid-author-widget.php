...
if (!class_exists('Ocius_Author_Widget')) :
     ...
     * @since Ocius 1.0.0
     */
    class Ocius_Author_Widget extends WP_Widget
    {
        ...
        {
            $opts = array(
                'classname' => 'ocius_widget_author',
                'description' => esc_html__('Display Author Profile.', 'ocius'),
            );
            parent::__construct('ocius-author', esc_html__('Ocius Author Widget', 'ocius'), $opts);
        }
        ...
        function widget($args, $instance)
        {
            ...
            <div class="ocius-author-profile">
                ...
                <div class="profile-wrapper social-menu-wrap">
                    ...
                    <?php if ($author_facebook || $author_twitter || $author_linkedin || $author_instagram || $author_pinterest || $author_youtube || $author_vk) { ?>
                        <ul class="menu author-social-profiles ocius-menu-social">
                            <?php if ($author_facebook) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_facebook); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('facebook', 'ocius'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_twitter) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_twitter); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('twitter', 'ocius'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_linkedin) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_linkedin); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('linkedin', 'ocius'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_instagram) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_instagram); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('instagram', 'ocius'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_pinterest) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_pinterest); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('pinterest', 'ocius'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_youtube) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_youtube); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('youtube', 'ocius'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_vk) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_vk); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('vk', 'ocius'); ?></span></a>
                                </li>
                            <?php } ?>
        ...
        function form($instance)
        {
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id('title')); ?>"><strong><?php esc_html_e('Title:', 'ocius'); ?></strong></label>
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id('author_description')); ?>"><strong><?php esc_html_e('Description:', 'ocius'); ?></strong></label>
            ...
            <p>
                ...
                <input type="button" class="button button-primary custom_media_button" id="custom_media_button"
                       name="<?php echo $this->get_field_name('author_image'); ?>"
                       value="<?php esc_attr_e('Upload Image', 'ocius') ?>"/>
            </p>

            <p>
                <label for="<?php echo esc_attr($this->get_field_name('author_facebook')); ?>">
                    <?php esc_html_e('Facebook:', 'ocius'); ?>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('author_instagram')); ?>">
                    <?php esc_html_e('Instagram:', 'ocius'); ?>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('author_pinterest')); ?>">
                    <?php esc_html_e('Pinterest:', 'ocius'); ?>
                </label>
...
add_action('admin_enqueue_scripts', 'ocius_widgets_backend_enqueue');
function ocius_widgets_backend_enqueue()
{
    wp_register_script('ocius-custom-widgets', get_template_directory_uri() . '/candidthemes/assets/js/widget.js', array('jquery'), true);
    wp_enqueue_media();
    wp_enqueue_script('ocius-custom-widgets');
}